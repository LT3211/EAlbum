...
<div class="main">
    <div class="title">
        <span>EAlbum添加图片</span>
    </div>
    <form class="login-form" enctype="multipart/form-data" action="AddPhoto"  method="post" novalidate>
        <!--输入框-->
        <div class="input-content" >
            <div>
                <input type="text" autocomplete="off"
                       placeholder="图片名称" name="photoName" required/>
            </div>
            <!-- 保存用户自定义的背景图片 -->
            <div id="head">
        ...
        <div style="text-align: center">
            <button type="submit" class="enter-btn">添加图片</button>
        </div>
    </form>
</div>
<div id="i-foot">
