...
<div class="main">
    <div class="title">
        <span>修改个人信息EAlbum</span>
    </div>
    <form class="login-form" enctype="multipart/form-data" action="Update" method="post" novalidate>
        <!--输入框-->
        <div class="input-content" >
            <!-- 保存用户自定义的背景图片 -->
            <div id="head">
                <img id="cropedBigImg" value='custom' alt="lorem ipsum dolor sit" src="<%=user.getHeadIcon()%>" data-address=''
                     title="自定义背景"/>
            ...
            <div>
                <input type="text" autocomplete="off"
                       value="<%=user.getNickName()%>" name="nickName"  required/>
            </div>
            <div>
                <input type="text" autocomplete="off"
                       value="<%=user.getDescription()%>" name="description" required/>
            </div>
            <div>
            ...
            <div>
                <input type="password" autocomplete="off"
                       value="<%=user.getPassword()%>"  name="repwd" required/>
            </div>
        </div>
        <!--登入按钮-->
        <div style="text-align: center">
            <button type="submit" class="enter-btn">修改信息</button>
        </div>
