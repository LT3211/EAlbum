...
<%List<Picdir> list = PicdirDao.queryByUserId(user.getId());%>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Title</title>
...
<div class="nav-bar">
    <div class="nav-info">
        <div class="headIcon">
            <img src="<%=user.getHeadIcon()%>" alt="头像">
        </div>
        <div style="float:left;width:400px;height: 150px;position: relative;">
            <div class="info">
                <h1><%=user.getNickName()%>
                </h1>
                <a href="update.jsp"><span class="setting"></span></a>
            </div>
            <div class="g47">
                <span><%=user.getTotal()%></span> 相册
            </div>
            <div class="g48">
    ...
    <div class="nav-photo">
        ...
        <div id="photo">
            ...
            %>
            <div id="p-jia">
                <a href="addPic.jsp"><img src="images/jia.jpg" id="jh"></a>
            </div>
        </div>
    </div>
</div>
